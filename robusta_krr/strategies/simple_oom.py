...
class SimpleOOMStrategy(BaseStrategy[SimpleStrategySettings]):
    """
    [yellow]This strategy is similar to simple, but also uses OOMKilled events and memory limits to calculate memory recommendations.
    Currently it is in a testing mode and may not work as expected. Use it at your own risk.[/yellow]
